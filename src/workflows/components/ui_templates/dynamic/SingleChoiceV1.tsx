 ...
 * SingleChoiceV1
 *
 * This component is one of many UI templates that may be displayed
 * to the user during an engagement with a WorkflowCollection.
 *
 * For this screen to be displayed, the `ui_template` specified
 * in the current Workflow's current step must be 'single_choice_v1'
 */
export default function SingleChoiceV1({
  step,
  backAction,
  nextAction,
  cancelAction,
