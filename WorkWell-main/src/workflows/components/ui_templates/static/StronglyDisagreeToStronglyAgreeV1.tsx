...
/**
 * StronglyDisagreeToStronglyAgreeV1
 *
 ...
 * in the current Workflow's current step must be 'strongly_disagree_to_strongly_agree_v1'
 */
export default function StronglyDisagreeToStronglyAgreeV1({
  step,
  backAction,
  nextAction,
  cancelAction,
